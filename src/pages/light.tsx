                        ...
                        <div>
                            ...
                            <div className="flex flex-row mt-4">
                                {Object.entries(dimensionsMapping!).map(([dimensionId, dimension]) => (
                                    <div key={dimensionId} className={`w-[200px] border-2 ${selectedDimensionId! === Number(dimensionId) ? 'border-pink-300' : 'border-gray-100'} text-black text-center px-2 py-2 rounded mr-2`} onClick={() => handleSelectDimension(Number(dimensionId))}>
                                        {dimension.length}m
                                    </div>
                                ))}
                            </div>
